...
<div class="flex flex-col md:flex-row items-start">
    ...
    <div class="md:ml-10 mt-5 md:mt-0 w-full md:w-2/3">
        ...
        <p class="text-lg mb-4 text-gray-400">
            Release Date:
            <span class="text-white"> {{ $movie['release_date'] }}</span></p>
        ...
        <div class="flex space-x-4 mt-5">
            ...
            <a href="{{ route('movie.destroy', $movieId) }}" onclick="event.preventDefault(); confirm('Are You Sure?'); document.getElementById('delete-form-{{ $movieId }}').submit();" class=" bg-red-600 p-1 rounded hover:bg-red-500">
                ❌
            </a>
        </div>
    </div>
